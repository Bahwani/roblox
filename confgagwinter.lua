_G.GAGConfig = _G.GAGConfig or {
    ...
    ["Planting"] = {
        ...
        ["Don't Plant"] = {},                 -- e.g. { "Cactus", "Pineapple", "Green Bean", "Banana", "Grape", "Coconut", "Mango", "Dragon Fruit", "Acorn", "Cherry" } 
        ["Don't Buy"]   = {},                 -- e.g. { "Cactus", "Pineapple", "Green Bean", "Banana", "Grape", "Coconut", "Mango" }
        ["Keep Seeds"]  = {                   -- e.g. { ["Moon Bloom"] = 5, Gold = 15 }  (keep N UNPLANTED)
            ["Dragon's Breath"] = 5, ["Moon Bloom"] = 5, ["Venom Spitter"] = 5,
            ["Gold"] = 2, ["Rainbow"] = 5, ["Mega"] = 5, ["Star Fruit"] = 5, ["Sun Bloom"] = 5,
        },
        ["Plant Limit"] = 30,                  -- number (0 = off). Cap TOTAL plants at this: never plant past it, AND if you're ALREADY over (e.g. 800), shovel the lowest-tier plants DOWN to it to cut lag / stop the game force-closing. Set ~200. Never shovels mutated (Gold/Rainbow/Mega), Mega-size, Plant-Plan or never-sell plants.
        ["Never Shovel"] = {},                -- e.g. { "Dragon Fruit", "Mango" }  (extra plants the Plant Limit shovel must NEVER remove — for your high-tier crops)
        ["Shovel Up To"] = "Legendary",                -- e.g. "Rare"  (a RARITY TIER — Common/Uncommon/Rare/Epic — removes ONLY that tier and below. "" = no extra ceiling. LEGENDARY/Mythic/Super are ALWAYS protected regardless. Single-harvest crops are HARVESTED when ripe, never shoveled — no wasted fruit)
        ["Shovel Mutated"] = true,           -- false = protect ALL mutated plants (default). true = the Plant-Limit shovel MAY remove ANY mutated plant (Gold/Rainbow/weather). OR a LIST to allow only some, e.g. { "Gold", "Rainbow" }. (Never Shovel / Plant Plan still protected. Tier is separate � raise "Shovel Up To". There's no size guard, so big/Mega plants can be shoveled too.)
        ["Buy Seeds"]    = {
            -- ["Carrot"] = 9999,
            -- ["Strawberry"] = 9999,
            -- ["Blueberry"] = 9999,
    ...
    ["Pets"] = {
        ...
        ["Auto Buy Slots"] = false,            -- true / false
    ...
    ["Gear"] = {
        ...
        ["Buy Gear"]             = { "Super Sprinkler", "Super Watering Can", "Trowel" },   -- e.g. { "Trowel" }  (buy & keep, never placed)
    },
    ["Event Seeds"] = {
    ...
    ["Mail"] = {
        ...
        ["Send"]       = {                    -- e.g. { "Gold", "Deer", { Item = "Deer", Count = 5 } }  (equipped pets never sent) { Item = "Gold", Count = 10 },
            "Moon Bloom", "Dragon's Breath", "Star Fruit", "Sun Bloom", "Hypno Bloom", { Item = "Rainbow", Count = 3 }, "Hypno Bloom", { Item = "Mega", Count = 3 }, { Item = "Gold", Count = 20 }, { Item = "Bamboo", Count = 500 }, { Item = "Mango", Count = 20 }, { Item = "Acorn", Count = 20 },
            "Unicorn", "Raccoon", "Firefly",
            { Item = "Super Sprinkler", Count = 3 }, { Item = "Legendary Sprinkler", Count = 5 }, { Item = "Super Watering Can", Count = 3 }, { Item = "Trowel", Count = 5000 },
        },
    },
    ["Misc"] = {
    ...
    ["Debug"] = {
        ...
        ["Console"]     = false,   -- true / false  (also print log lines to the executor console). Or a list to filter, e.g. { "REPLACE", "ERROR" }
    },
}
